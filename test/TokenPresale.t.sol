...
contract TokenPresaleTest is Test {
    ...
    address public buyer4 = address(0x5);
    ...
    function testWithdrawFundsSuccess() public {
        ...
        assertEq(
            ...
            "Owner should receive raised ETH"
        );
    }
    ...
    function testRescueERC20Success() public {
        ...
        assertEq(
            ...
            ownerBalanceBefore + rescueAmount
        );
    }
    ...
    function testFullSuccessfulPresaleFlow() public {
        ...
        // Total: 5 ETH raised, 5000 tokens sold, soft cap met
        assertEq(presale.totalRaised(), 5 ether);
        assertEq(presale.totalSold(), 5000 ether);
        ...
        console.log(
            "Owner token balance before withdrawal:",
        ...
        assertEq(
            ...
            ownerTokenBalanceBefore + (depositAmount - 5000 ether)
        );
    }
